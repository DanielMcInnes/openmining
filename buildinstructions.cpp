...
- sudo apt-get install build-essential perl python git "^libxcb.*" libx11-xcb-dev libglu1-mesa-dev libxrender-dev flex bison gperf libicu-dev libxslt-dev ruby libasound2-dev libgstreamer0.10-dev libgstreamer-plugins-base0.10-dev libpq5 libpq-dev libboost-serialization1.48 postgresql-client-9.1

# optional extras
sudo apt-get install synaptic cscope
- mkdir ~/openmining 
...
error: ‘class QOpenGLFunctions’ has no member named ‘glReadPixels’
